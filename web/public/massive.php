...
<section class="py-7 py-md-0 bg-hero" id="content">
    ...
    <div class="container">
        ...
        <br>
        <h3 style="color:white;text-align:center">How many VM would you like to provision ?</h3>        
        <div >
            <input type="text" id="countvm" placeholder="How many VM would you like to provision ?" />
        </div>
        
        <br>
        <h3 style="color:white;text-align:center">Create a ressource groupe</h3>
        ...
        <h3 style="color:white;text-align:center">  Create virtual network</h3>
        ...
        <h3 style="color:white;text-align:center"> Create subnet</h3>
        ...
        <h3 style="color:white;text-align:center">Create public IP</h3>        
        <div >
        ...
        <p style="color:white;font-size:25px;"> Allocation method</p>
            ...
            <div id="ifstatic" style="display:none"> <br>
                    <input type='text' id='prefixpub' name='prefixpub' placeholder="Add a public IP "><br><br>
            </div> <br>


        <h3 style="color:white;text-align: center;">Create Network Security Group and rules</h3>
        <div >
...
--> 
       <div  style="text-align: left;">
        ...
        <h3 style="color:white;text-align: center;">Create Network interface</h3>
    ...
    <h3 style="color:white;text-align: center;"> create virtual machine </h3>
    ...
    <div >
        <select id="source_image">
            ...
            <option value="CentOS">Centos 7.7</option>
            <option value="WindowsServer">Windows server 2016</option>
            <option value="Windows-10">Windows 10 Professional</option>
        </select>
    </div><br>
...
<script>  
  ...
  /*  function CheckOther(selectBox){
    ...
    let saveFile = () => {
        ...
        var ubuntu = ' \r storage_image_reference { ' + ' \r\n ' +'  publisher = "Canonical"' + '\r\n' +
            '   offer ="' + source_image.value + '"' + '\r\n ' + '  sku = "18.04-LTS" ' + ' \r\n ' + 
            '  version = "latest" '+  '\r\n ' + ' }' +  '\r\n ' +
            ' \r os_profile_linux_config { ' + ' \r\n ' +'  disable_password_authentication = false' + '\r\n' +' }' + '\r\n ' 

        var centos = ' \r storage_image_reference { ' + ' \r\n ' +'  publisher = "Canonical"' + '\r\n' +
            '   offer ="' + source_image.value + '"' + '\r\n ' + '  sku = "18.04-LTS" ' + ' \r\n ' + 
            '  version = "latest" '+  '\r\n ' + ' }' +  '\r\n ' +
            ' \r os_profile_linux_config { ' + ' \r\n ' +'  disable_password_authentication = false' + '\r\n' +' }' + '\r\n ' 


        var winserv16 = ' \r storage_image_reference { ' + ' \r\n ' +'  publisher = "MicrosoftWindowsServer"' + '\r\n' +
            '   offer ="' + source_image.value + '"' + '\r\n ' + '  sku = "2016-Datacenter" ' + ' \r\n ' + 
            '  version = "latest" '+  '\r\n ' + ' }' +  '\r\n ' +
            ' \r os_profile_windows_config { ' + ' \r\n ' +'  provision_vm_agent = "false"' + '\r\n' +' }' + '\r\n ' 


        var win10 = ' \r storage_image_reference { ' + ' \r\n ' +'  publisher = "MicrosoftWindowsDesktop"' + '\r\n' +
            '   offer ="' + source_image.value + '"' + '\r\n ' + '  sku = "20h1-pro" ' + ' \r\n ' + 
            '  version = "latest" '+  '\r\n ' + ' }' +  '\r\n ' +
            ' \r os_profile_windows_config { ' + ' \r\n ' +'  provision_vm_agent = "false"' + '\r\n' +' }' + '\r\n ' 
        ...
        function src_img (){
            if(document.getElementById('source_image').value == "CentOS") {
                return centos
            } else if(document.getElementById('source_image').value == "UbuntuServer") {
                return ubuntu     
            }
            else if(document.getElementById('source_image').value == "WindowsServer") {
                return winserv16     
            }
            else return win10   
